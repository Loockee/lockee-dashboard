    ...
    <b-row class="app-row survey-app pb-4">
      <b-colxx xxs="12" v-if="isLoadSurveys" key="surveyDetail">
        ...
        >
                      ...
                      <table class="table table-sm table-borderless">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="p-0 pb-1">
                              <span
                                class="font-weight-medium text-muted text-small"
                              >95/125 High School</span>
                            </td>
                          </tr>
                        </tbody>
                      </table>
          ...
          <b-tab :title="$t('profile.experiences')">
            <b-row>
              <b-colxx xxs="12" lg="4">
                <b-card class="mb-4" no-body>
                  <b-card-body>
                    <h5 class="card-title">Experiences status</h5>
                    <div class="">
                      <p>test content</p>
                    </div>
                  </b-card-body>
          ...
          <b-tab :title="$t('profile.relationships')">
            <b-row>
              <b-colxx xxs="12" lg="4">
                <b-card class="mb-4" no-body>
                  <b-card-body>
                    <h5 class="card-title">Employee Network</h5>
                    <div class="chart-container">
                      <div class="">
                        <p>test content</p>
                      </div>
